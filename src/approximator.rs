...
pub fn approximate_image(image:&ImageBuffer<Luma<u8>,Vec<u8>>,order:usize,omega:f32,drop_bright:bool)->Vec<((f32, f32), (f32, f32))>{
    ...
    return thicken_lines_sin(&lines, &thicknesses, omega,drop_bright);
